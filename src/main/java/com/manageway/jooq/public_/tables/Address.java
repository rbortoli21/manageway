...
public class Address extends TableImpl<AddressRecord> {
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, null, Keys.CUSTOMER__FKGLKHKMH2VYN790IJS6HIQQPI.getInverseKey());
    ...
    public EmployeePath employee() {
        if (_employee == null)
            _employee = new EmployeePath(this, null, Keys.EMPLOYEE__FKGA73HDTPB67TWLR9C1I337TYT.getInverseKey());
