...
public class Employee extends TableImpl<EmployeeRecord> {
     ...
     */
    public final TableField<EmployeeRecord, String> PHONE = createField(DSL.name("phone"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.employee.balance</code>.
     */
    public final TableField<EmployeeRecord, Double> BALANCE = createField(DSL.name("balance"), SQLDataType.DOUBLE, this, "");
    ...
    public List<UniqueKey<EmployeeRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UKQRBSK9LJMHFJE93ME0N7XWDXQ);
    }

    @Override
    public List<ForeignKey<EmployeeRecord, ?>> getReferences() {
        return Arrays.asList(Keys.EMPLOYEE__FKGA73HDTPB67TWLR9C1I337TYT);
    }
    ...
    public AddressPath address() {
        if (_address == null)
            _address = new AddressPath(this, Keys.EMPLOYEE__FKGA73HDTPB67TWLR9C1I337TYT, null);
    ...
    public EmployeeCustomersPath employeeCustomers() {
        if (_employeeCustomers == null)
            _employeeCustomers = new EmployeeCustomersPath(this, null, Keys.EMPLOYEE_CUSTOMERS__FK39G7K2KR81EXXSJFMGHSNHW3Q.getInverseKey());
    ...
    public EmployeeProjectsPath employeeProjects() {
        if (_employeeProjects == null)
            _employeeProjects = new EmployeeProjectsPath(this, null, Keys.EMPLOYEE_PROJECTS__FK97JL81FSRBBLKQFOQWG2O7YPS.getInverseKey());
    ...
    public ProjectPath project() {
        if (_project == null)
            _project = new ProjectPath(this, null, Keys.PROJECT__FKOX7XSYL6K8FC7AQ1MPE8507HF.getInverseKey());
