...
public class EmployeeRecord extends UpdatableRecordImpl<EmployeeRecord> {
     ...
     */
    public EmployeeRecord(UUID id, LocalDateTime createdAt, UUID tenantId, LocalDateTime updatedAt, LocalDateTime birthDate, String email, String name, String phone, Double balance, UUID addressId) {
        super(Employee.EMPLOYEE);
