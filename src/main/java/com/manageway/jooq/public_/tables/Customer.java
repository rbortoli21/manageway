...
import com.manageway.jooq.public_.tables.Address.AddressPath;
import com.manageway.jooq.public_.tables.EmployeeCustomers.EmployeeCustomersPath;
...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, String> PHONE = createField(DSL.name("phone"), SQLDataType.VARCHAR(255), this, "");
    ...
    public List<UniqueKey<CustomerRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UKR8WHBD0MF9ER6VWFR0SCLSXKD);
    }

    @Override
    public List<ForeignKey<CustomerRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CUSTOMER__FKGLKHKMH2VYN790IJS6HIQQPI);
    }
    ...
    public AddressPath address() {
        if (_address == null)
            _address = new AddressPath(this, Keys.CUSTOMER__FKGLKHKMH2VYN790IJS6HIQQPI, null);
    ...
    public EmployeeCustomersPath employeeCustomers() {
        if (_employeeCustomers == null)
            _employeeCustomers = new EmployeeCustomersPath(this, null, Keys.EMPLOYEE_CUSTOMERS__FK63F2ACW1TLHYVCWPW2557699M.getInverseKey());
    ...
    public ProjectPath project() {
        if (_project == null)
            _project = new ProjectPath(this, null, Keys.PROJECT__FKJ948TRU2ILGQXFXSPPP9MOM5J.getInverseKey());
