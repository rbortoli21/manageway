...
public class Project extends TableImpl<ProjectRecord> {
     ...
     */
    public final TableField<ProjectRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(60).nullable(false), this, "");

    /**
     * The column <code>public.project.start_date</code>.
     */
    public final TableField<ProjectRecord, LocalDateTime> START_DATE = createField(DSL.name("start_date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
     ...
     */
    public final TableField<ProjectRecord, BigDecimal> TOTAL_PRICE = createField(DSL.name("total_price"), SQLDataType.NUMERIC(10, 2), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_PROJECT_TENANT_ID);
    }
    ...
    public List<ForeignKey<ProjectRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PROJECT__FK_PROJECT_EMPLOYEE, Keys.PROJECT__FK_PROJECT_CUSTOMER);
    }
    ...
    public EmployeePath employee() {
        if (_employee == null)
            _employee = new EmployeePath(this, Keys.PROJECT__FK_PROJECT_EMPLOYEE, null);
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, Keys.PROJECT__FK_PROJECT_CUSTOMER, null);
    ...
    public EmployeeProjectsPath employeeProjects() {
        if (_employeeProjects == null)
            _employeeProjects = new EmployeeProjectsPath(this, null, Keys.EMPLOYEE_PROJECTS__FK_EMPLOYEE_PROJECTS_PROJECT.getInverseKey());
